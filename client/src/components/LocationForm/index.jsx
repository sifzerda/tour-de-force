  ...
  return (
    <div className="card-x">
      <div className="card-body">
        ...
        <h5 className="card-title-x">Check ticket availability for {name}</h5>
        <form>
        ...
        {showAvailability && (
          <div className="availability-card">
            <h5 className='h5-white'>Availability for {name}</h5>
            <p className='p-white'>Venue: {selectedVenue}</p>
            <p className='p-white'>Date: {dayjs(parseInt(selectedTime)).format('DD/MM/YYYY')}</p>
            <h5 className='h5-white'>Seat Map:</h5>
            {generateSeatMap()}
