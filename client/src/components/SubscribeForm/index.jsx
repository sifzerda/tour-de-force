          ...
          <div id="sib-container" className="sib-container--large sib-container--vertical" style={{ textAlign: 'center', backgroundColor: 'rgba(255,255,255,1)', maxWidth: '540px', borderRadius: '3px', borderWidth: '1px', borderColor: '#C0CCD9', borderStyle: 'solid', direction: 'ltr' }}>
            <form id="sib-form" method="POST" action="https://76aa2c05.sibforms.com/serve/MUIFAMTPhWySZwrF6yv6NoVxDQvmmyBRRx2pOjlWRJQDsGLX0lk0IRAOvyz1k_j1f7Gd91zxleeC7SWskCHe03IuIhNfIu4lY0KZmMbft8hDBVdZJ7c9ltmOAlFoIQhZq_ofbo0TuZR2pS-7-Px4lFIdIaeke8Uf5ACyENZNB-dHkNjAJW1y_dHysMhp0-ZT55CiqjcNvQqv05Pn" data-type="subscription">
              <div style={{ padding: '8px 0' }}>
                <div className="sib-form-block" style={{ fontSize: '32px', textAlign: 'center', fontWeight: '700', fontFamily: 'Helvetica, sans-serif', color: '#3C4858', backgroundColor: 'transparent', textAlign: 'center' }}>
                  <p>Subscribe</p>
                </div>
              </div>
              <div style={{ padding: '8px 0' }}>
                <div className="sib-form-block" style={{ fontSize: '16px', textAlign: 'center', fontFamily: 'Helvetica, sans-serif', color: '#3C4858', backgroundColor: 'transparent', textAlign: 'center' }}>
                ...
                <div className="sib-input sib-form-block">
                  <div className="form__entry entry_block">
                    <div className="form__label-row ">
                      <label className="entry__label" style={{ fontWeight: '700', textAlign: 'left', fontSize: '16px', textAlign: 'left', fontWeight: '700', fontFamily: 'Helvetica, sans-serif', color: '#3c4858' }} htmlFor="EMAIL" data-required="*">Enter your email address to subscribe</label>
              ...
              <div style={{ padding: '8px 0' }}>
                <div className="sib-form-block" style={{ textAlign: 'center' }}>
                  <button className="sib-form-block__button sib-form-block__button-with-loader" style={{ fontSize: '16px', textAlign: 'center', fontWeight: '700', fontFamily: 'Helvetica, sans-serif', color: '#FFFFFF', backgroundColor: '#3E4857', borderRadius: '3px', borderWidth: '0px' }} form="sib-form" type="submit">
